...
class __TwigTemplate_b52a6eef601424ec8ca308ab0d8e4a19 extends Template
{
    ...
    <form method=\"post\">
        ...
        echo "\" name=\"email\" id=\"inputEmail\" class=\"input-form\" autocomplete=\"email\" required autofocus>
        </div>
        <div class=\"elt-frm-inscri\">
            <label class=\"lbl-form\" for=\"inputPassword\">Mot de passe :</label>
            <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"input-form\" autocomplete=\"current-password\" required>
        </div>
        ...
        <button class=\"btn-create-acc\" type=\"submit\">
            Se connecter
        </button>
    </form>
</div>
";
    ...
    {
        return array (  131 => 27,  121 => 20,  116 => 17,  108 => 14,  105 => 13,  103 => 12,  100 => 11,  94 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"inscription-container\">
    <form method=\"post\">
        ...
        <div class=\"elt-frm-inscri\">
            <label class=\"lbl-form\" for=\"email\">Email :</label><br>
            <input type=\"email\" value=\"{{ last_username }}\" name=\"email\" id=\"inputEmail\" class=\"input-form\" autocomplete=\"email\" required autofocus>
        </div>
        <div class=\"elt-frm-inscri\">
            <label class=\"lbl-form\" for=\"inputPassword\">Mot de passe :</label>
            <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"input-form\" autocomplete=\"current-password\" required>
